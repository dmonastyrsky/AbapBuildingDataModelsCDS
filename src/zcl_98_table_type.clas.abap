CLASS zcl_98_table_type DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    " ---------------------------------------------------------------------
    TYPES tt_addresses TYPE SORTED TABLE OF z98s_address
...
CLASS zcl_98_table_type IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    " Task 1
    " ---------------------------------------------------------------------
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z98t_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE z98s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE Z98T_PERSONS.
