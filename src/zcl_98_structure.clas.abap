CLASS zcl_98_structure DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
*            INCLUDE TYPE Z98S_NAME    AS name.
*            INCLUDE TYPE Z98S_ADDRESS AS address.
*    TYPES END OF st_person_inc.
ENDCLASS.


CLASS zcl_98_structure IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    " Task 1
    " ---------------------------------------------------------------------
    "    DATA address TYPE st_address.
    DATA address TYPE z98s_address.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE z98s_person_inc.
